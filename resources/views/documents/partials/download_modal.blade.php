<div x-data="{ open: false, documentId: null, confirmDownload() { window.location.href = '/documents/' + this.documentId + '/download'; this.open = false; } }"
     @open-download-modal.window="open = true; documentId = $event.detail.id;">
