...
<head>
    ...
    <title>{{ __('Document mis à jour') }}</title>
</head>
    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid rgba(0,0,0,.08);border-radius:16px;overflow:hidden;">
            <div style="padding:18px 20px;background:#0b1a3a;color:#ffffff;">
                ...
                <div style="font-size:18px;font-weight:700;margin-top:4px;">{{ __('Document mis à jour') }}</div>
            </div>
            <div style="padding:20px;">
                ...
                <div style="border:1px solid rgba(0,0,0,.08);border-radius:12px;padding:14px;">
                    ...
                    <div style="height:10px"></div>
                    <div style="font-size:12px;color:#64748b;">{{ __('Version') }}</div>
                    ...
                    @if (!empty($changeSummary))
                        ...
                        <div style="font-size:12px;color:#64748b;">{{ __('Résumé des modifications') }}</div>
