...
<head>
    ...
    <title>{{ __('Document partagé') }}</title>
</head>
    ...
    <div style="max-width:640px;margin:0 auto;padding:24px;">
        <div style="background:#ffffff;border:1px solid rgba(0,0,0,.08);border-radius:16px;overflow:hidden;">
            <div style="padding:18px 20px;background:#0b1a3a;color:#ffffff;">
                ...
                <div style="font-size:18px;font-weight:700;margin-top:4px;">{{ __('Un document vous a été partagé') }}</div>
            </div>
            <div style="padding:20px;">
                ...
                <p style="margin:0 0 14px 0;font-size:14px;">
                    ...
                    {{ __('vous a transféré un document dans SIKDS. Vous pouvez désormais le consulter et le télécharger depuis votre espace.') }}
                </p>
