...
$items = [
    ...
    ['id' => 'indexing', 'label' => 'Moniteur Indexation', 'icon' => '/indexing.svg', 'icon_active' => '/indexing-blue.svg', 'href' => $safeRoute('indexing.index'), 'visible' => $isSuperAdmin || $authUser?->can('indexing.manage')],
