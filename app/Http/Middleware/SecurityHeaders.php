...
class SecurityHeaders
{
    ...
    {
        // Inline styles and scripts are still in use across Blade views; until
        // we move to nonces, allow 'unsafe-inline' but keep the other directives
        // strict so XSS via injected <iframe>, <object>, or <base> is still blocked.
        $directives = [
            "default-src 'self'",
